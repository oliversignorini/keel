"""Always-visible CI output for the audit meta-test (PRD v1.2 §8): "print
every not_audited reason in CI output, on the same principle as
...
def pytest_terminal_summary(terminalreporter: Any, exitstatus: int, config: Any) -> None:
    terminalreporter.section("@not_audited reasons (audit meta-test, PRD v1.2 §8)")

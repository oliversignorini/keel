...
class WidgetsConfig(AppConfig):
    ...
    def ready(self) -> None:
        ...
        # keel.billing.entitlements.check_limit. check_limit raises
        # UnregisteredResource for a name nobody registered a counter for,
        # so this has to exist before any service calls it — hence
        # AppConfig.ready(), not import time.
